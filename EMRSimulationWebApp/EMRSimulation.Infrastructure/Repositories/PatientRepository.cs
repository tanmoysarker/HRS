    ...
    public class PatientRepository : IPatientRepository
    {
        ...
        public async Task<int> DeleteIvFluidChartAsync(int Id)
        {
            using (var connection = await _dbConnectionFactory.CreateAsync())
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "DeleteIvFluidChart"; // Stored procedure name
        ...
        public async Task<int> DeleteMedicationPrnChartAsync(int Id)
        {
            using (var connection = await _dbConnectionFactory.CreateAsync())
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "DeleteMedicationPrnChart"; // Stored procedure name
        ...
        public async Task<int> DeleteMedicationRegularChartAsync(int Id)
        {
            using (var connection = await _dbConnectionFactory.CreateAsync())
            {
                ...
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.CommandText = "DeleteMedicationRegularChart"; // Stored procedure name
